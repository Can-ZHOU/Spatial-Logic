...
def analysisClean(fileName1, fileName2, reportFileName):
    ...
    report += prettyPrint(unique_t2)
    report += prettyPrint(unique_t3)
...
fileName2 = path + "nott_LD_t2_old.txt"
reportFileName = path + "diff_nott_t2.txt"
analysisClean(fileName1, fileName2, reportFileName)
fileName1 = path + "nott_LD_t3.txt"
fileName2 = path + "nott_LD_t3_old.txt"
reportFileName = path + "diff_nott_t3.txt"
analysisClean(fileName1, fileName2, reportFileName)

fileName1 = path + "south_LD_t2.txt"
fileName2 = path + "south_LD_t2_old.txt"
reportFileName = path + "diff_south_t2.txt"
analysisClean(fileName1, fileName2, reportFileName)
fileName1 = path + "south_LD_t3.txt"
fileName2 = path + "south_LD_t3_old.txt"
reportFileName = path + "diff_south_t3.txt"
analysisClean(fileName1, fileName2, reportFileName)