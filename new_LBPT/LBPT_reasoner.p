...
;;;    atms_assume_all(premises);
    ...
    ;;;printable_atms_nogoods() -> no_goods_length;
    ;;;no_goods_length ==> 
...
;;; nott_6.txt is too big to run.
vars poparglist = ['nott_0.txt' 'nott_1.txt' 'nott_2.txt' 'nott_3.txt' 'nott_4.txt' 'nott_5.txt' 'nott_7.txt' 'nott_8.txt' 'nott_9.txt' 'nott_10.txt' 'nott_11.txt' 'nott_12.txt' 'nott_13.txt' 'nott_14.txt' 'nott_15.txt'];
;;;vars poparglist = ['nott_13.txt'];
run_reasoner(poparglist);

;;; load LBPT_reasoner.p;
