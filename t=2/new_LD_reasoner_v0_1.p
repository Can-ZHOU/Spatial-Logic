...
define dimensional_split(relation) -> bool;
    ...
    (p = "E" or p = "W" or p = "Iew" or p = "dE" or p = "dW" or p = "nEW" or p="sE" or p="sW") then
        false -> bool;
    else
        true -> bool;
    endif;
...
define check_assumptions(assumptions);
	...
	if (assumption fmatches [E = =] or assumption fmatches [W = =] or assumption fmatches [Iew = =] or assumption fmatches [dE = =] or assumption fmatches [dW = =] or assumption fmatches [nEW = =] or assumption fmatches [sE = =] or or assumption fmatches [sW = =] or
...
vars poparglist = ['south_7_ew.txt'];
